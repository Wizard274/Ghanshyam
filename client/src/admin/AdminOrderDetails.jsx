...
import { orderAPI, invoiceAPI, userAPI, IMAGE_BASE_URL } from "../services/api";
        ...
        <div className="card">
          ...
          {[
            ...
            <div key={r.label} style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid var(--border)", fontSize: 14 }}>
              ...
              {r.label === "Address" && r.value !== "—" ? (
                <span style={{ fontWeight: 500, textAlign: "right" }}>
                  <a href={`https://maps.google.com/?q=${encodeURIComponent(r.value)}`} target="_blank" rel="noreferrer" style={{ color: "var(--primary)", textDecoration: "underline" }} title="Open in Google Maps">
                     <i className="fa-solid fa-map-location-dot" style={{ marginRight: 6 }} />{r.value}
                  </a>
                </span>
              ) : (
